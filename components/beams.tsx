...
const Beams: FC<BeamsProps> = ({
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`,
        ...
        material: { fog: true },
        uniforms: {
          // base diffuse → blue-100
          diffuse: new THREE.Color(...hexToNormalizedRGB("#93c5fd")),
  ...
  return (
    <CanvasWrapper>
      <group rotation={[0, 0, degToRad(rotation)]}>
        ...
        />
        {/* beams → blue-300 */}
        <DirLight color={"#60a5fa"} position={[0, 3, 10]} />
      </group>
...
// const CanvasWrapper: FC<{ children: ReactNode; backgroundColor?: string }> = ({ 
//   children, 
